...
async function prospectiveServerPrerender(
  ...
  const initialServerPrerenderStore: PrerenderStore = {
    ...
    prerenderResumeDataCache: null, // This is a dynamic request, so we're not populating a prerender data cache.
    renderResumeDataCache: requestStore.renderResumeDataCache,
